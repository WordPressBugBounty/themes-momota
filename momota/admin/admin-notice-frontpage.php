...
use MomotaTheme\SiteLeadsThemeKit\SiteLeads;
...
<div class="momota-admin-big-notice--container">
	<div class="logo-holder">
        <h2><?php echo sprintf(__("Choose one of the %s predefined designs to start with:", 'momota'), ucfirst(get_stylesheet())); ?></h2>
	</div>
